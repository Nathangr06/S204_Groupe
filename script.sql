...
-- id proprio : 1, 2, 3, 6, 8, 10, 11, 12, 13, 15, 16, 18, 20, 21, 22 (len=15)
...
INSERT INTO BIEN(IDEBIEN,CATEGORIE, TYPE, IDP, VILLE, PRIX) VALUES(2100, 'VILLA', 'T4', 22, 'CEYRESTE', 5);
...
INSERT INTO BIEN(IDEBIEN,CATEGORIE, TYPE, IDP, VILLE, PRIX) VALUES(6100, 'HLM', 'T2', 16, 'AIX-EN-PROVENCE', 50000);
